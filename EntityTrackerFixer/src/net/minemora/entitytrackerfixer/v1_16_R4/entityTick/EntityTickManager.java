package net.minemora.entitytrackerfixer.v1_16_R4.entityTick;
...
import net.minecraft.server.v1_16_R4.EntityInsentient;
...
public class EntityTickManager implements Listener {
    ...
    public void disableTicking(net.minecraft.server.v1_16_R4.Entity entity) {
    	if(entity == null) {
			return;
		}
		if(!entity.valid) {
    ...
    public void enableTicking(Set<net.minecraft.server.v1_16_R4.Entity> entities) {
    	for(net.minecraft.server.v1_16_R4.Entity entity : entities) {
    		if(entity == null) {
    			continue;
    		}
    		if(!entity.valid) {
    ...
    public void onChunkLoad(ChunkLoadEvent event) {
    	for(Entity entity : event.getChunk().getEntities()) {
    		net.minecraft.server.v1_16_R4.Entity nms = ((CraftEntity)entity).getHandle();
