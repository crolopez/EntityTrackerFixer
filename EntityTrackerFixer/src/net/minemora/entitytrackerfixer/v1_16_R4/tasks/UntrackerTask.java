package net.minemora.entitytrackerfixer.v1_16_R4.tasks;
...
import org.bukkit.craftbukkit.v1_16_R4.CraftWorld;
import org.bukkit.scheduler.BukkitRunnable;

import net.minecraft.server.v1_16_R4.ChunkProviderServer;
import net.minecraft.server.v1_16_R4.EntityArmorStand;
import net.minecraft.server.v1_16_R4.EntityComplexPart;
import net.minecraft.server.v1_16_R4.EntityEnderDragon;
import net.minecraft.server.v1_16_R4.EntityPlayer;
import net.minecraft.server.v1_16_R4.MinecraftServer;
import net.minecraft.server.v1_16_R4.WorldServer;
import net.minecraft.server.v1_16_R4.PlayerChunkMap.EntityTracker;
...
import net.minemora.entitytrackerfixer.v1_16_R4.entityTick.EntityTickManager;
	...
	private void untrackProcess(String worldName) {
		...
		try {
	        for(EntityTracker et : cps.playerChunkMap.trackedEntities.values()) {
	           net.minecraft.server.v1_16_R4.Entity nmsEnt = (net.minecraft.server.v1_16_R4.Entity) trackerField.get(et);
